    ...
    <div class="container-article news relative clearfix">
        <div class="col-md-4">
            ...
            foreach ($tree as $value){
                ...
                echo '<img class="img-std-place"  src="'.$my_image_url.'" al="'.$value->name.'"/>';
                echo '<img class="img-std-place-hover"  src="'.$my_image_url_hover_redy.'" alt="'.$value->name.'" />';
                echo '</div>';
                echo '</a></li>';
