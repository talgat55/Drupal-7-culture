...
$field_link = field_get_items('node', $node, 'field_link_archelogy');
$field_link_title = field_get_items('node', $node, 'field_title_link_archelogy');
$field_link_path = field_get_items('node', $node, 'field_path_link_archelogy');
?>
<div id="main" class="clearfix">
    ...
    <div class="container-article turizm-node relative clearfix">
        <div class="col-md-4">
            ...
            $query->entityCondition('entity_type', 'node')
                ->entityCondition('bundle', 'archelogy')
    ...
    <div class="article-slider-row">
        <div class="article-slider">
            <?php
            $field_gallery = field_get_items('node', $node, 'field_gallery_archelogy');
