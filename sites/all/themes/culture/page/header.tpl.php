                        ...
                        <div class="right-top-header">
                            ...
                            <div class="top-header-menu">
                                <ul class="links inline clearfix menu-contact">
                                    <li class="menu-383 first last"><a class="contact" href="#" title="Контакты">Контакты</a> </li>
                                    <li class="menu-383 first last"><a class="about" href="#" title="О Нас">О Нас</a> </li>
                                </ul>
                                <div class="block-contact-popup" itemscope itemtype="http://schema.org/Organization">
                                    ...
                                    <div class="c-content" itemprop="address" itemscope=""
                                        ...
                                        <div class="text" itemprop="streetAddress"><?php echo theme_get_setting('header_block_contact_adress'); ?></div>
                                        <div class="separator"><img
                                        ...
                                        <div class="text">
                                            <?php echo theme_get_setting('header_block_contact_content'); ?>
                                        </div>
                                        <div class="separator"><img
                                        ...
                                        <div class="text"><a href="mailto:<?php echo theme_get_setting('header_block_contact_email'); ?>" itemprop="email"><?php echo theme_get_setting('header_block_contact_email'); ?></a>
                                        </div>

                                    </div>
                                </div>
                                <div class="block-contact-popup-about"  >
                                    <a href="#" class="close"><img
                                                src="data:image/png;base64,"></a>
                                    <div class="c-content">
                                        <?php echo theme_get_setting('header_block_about'); ?>
                                    </div>
                                </div>
